...
def main():
    ...
    sales_data = load_and_display_data("../RowData/data.csv")
    weather_data = load_and_display_data("../RowData/weather.csv")
    fuel_data = load_and_display_data("../RowData/fuel_pricing.csv")
